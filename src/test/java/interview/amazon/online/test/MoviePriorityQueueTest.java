 ...
 */
public class MoviePriorityQueueTest {
  @Test
  public void getMovieRecommendations() throws Exception {
    MoviePriorityQueue moviePriorityQueue = new MoviePriorityQueue();
    ...
    // When
    Set<Movie> movieRecommendations = moviePriorityQueue.getMovieRecommendations(a, 1);
