 ...
 * to keep track of an entire n^2 board. We only need to keep a count_bruteForce for each row and column. If at any time a row or
 ...
 * of the two diagonals. Each time a player moves, just need to check the count_bruteForce of that row, column, diagonal and anti-diagonal.
 */
