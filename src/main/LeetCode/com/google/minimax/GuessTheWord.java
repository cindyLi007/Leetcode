 ...
 * words which have at least 1 match with the candidate word. Additionally, in order to delete a max part of words, we
 * select a candidate who has a big "family" (fewest 0 match with other words).
 */
public class GuessTheWord {
  public void findSecretWord(String[] wordlist, Master master) {
    while (wordlist.length > 0) {
      ...
      // this is a good way to convert List to Array
  ...
  private String preprocess(String[] wordlist) {
    ...
    // map store for each word, how many words in the wordlist has 0 match with this word, finally we need choose a
    // least number word from this map, because we need a "big word family"
